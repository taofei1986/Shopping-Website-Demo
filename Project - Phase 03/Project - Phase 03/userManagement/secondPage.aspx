<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="secondPage.aspx.cs" Inherits="Project___Phase_03.secondPage" %>
...
<body>
    ...
    <div>
        ...
        <asp:button Text="UPDATE" runat="server" PostBackUrl="~/updatePage.aspx"/>
    </div>
    </form>
</body>
</html>
